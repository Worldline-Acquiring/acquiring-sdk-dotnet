        ...
        public async Task TestMultipartFormDataUploadPostMultipartFormDataObjectWithResponse()
        {
            ...
            try
            {
                ...
                using (var communicator = Factory.CreateCommunicator(configuration))
                {
                    ...
                    var response = await communicator.Post<HttpBinResponse>("/anything/operations", null, null, multipart, null);
        ...
        public async Task TestMultipartFormDataUploadPostIMultipartFormDataRequestWithResponse()
        {
            ...
            try
            {
                ...
                using (var communicator = Factory.CreateCommunicator(configuration))
                {
                    ...
                    var response = await communicator.Post<HttpBinResponse>("/anything/operations", null, null, new MultipartFormDataObjectWrapper(multipart), null);
        ...
        public async Task TestMultipartFormDataUploadPostMultipartFormDataObjectWithBodyHandler()
        {
            ...
            try
            {
                ...
                using (var communicator = Factory.CreateCommunicator(configuration))
                {
                    ...
                    await communicator.Post("/anything/operations", null, null, multipart, (stream, headers) => {
        ...
        public async Task TestMultipartFormDataUploadPostIMultipartFormDataRequestWithBodyHandler()
        {
            ...
            try
            {
                ...
                using (var communicator = Factory.CreateCommunicator(configuration))
                {
                    ...
                    await communicator.Post("/anything/operations", null, null, new MultipartFormDataObjectWrapper(multipart), (stream, headers) => {
                        var response = DefaultMarshaller.Instance.Unmarshal<HttpBinResponse>(stream);
        ...
        public async Task TestMultipartFormDataUploadPutMultipartFormDataObjectWithResponse()
        {
            ...
            try
            {
                ...
                using (var communicator = Factory.CreateCommunicator(configuration))
                {
                    ...
                    var response = await communicator.Put<HttpBinResponse>("/anything/operations", null, null, multipart, null);
        ...
        public async Task TestMultipartFormDataUploadPutIMultipartFormDataRequestWithResponse()
        {
            ...
            try
            {
                ...
                using (var communicator = Factory.CreateCommunicator(configuration))
                {
                    ...
                    var response = await communicator.Put<HttpBinResponse>("/anything/operations", null, null, new MultipartFormDataObjectWrapper(multipart), null);
        ...
        public async Task TestMultipartFormDataUploadPutMultipartFormDataObjectWithBodyHandler()
        {
            ...
            try
            {
                ...
                using (var communicator = Factory.CreateCommunicator(configuration))
                {
                    ...
                    await communicator.Put("/anything/operations", null, null, multipart, (stream, headers) => {
                        var response = DefaultMarshaller.Instance.Unmarshal<HttpBinResponse>(stream);
        ...
        public async Task TestMultipartFormDataUploadPutIMultipartFormDataRequestWithBodyHandler()
        {
            ...
            try
            {
                ...
                using (var communicator = Factory.CreateCommunicator(configuration))
                {
                    ...
                    await communicator.Put("/anything/operations", null, null, new MultipartFormDataObjectWrapper(multipart), (stream, headers) => {
                        var response = DefaultMarshaller.Instance.Unmarshal<HttpBinResponse>(stream);
