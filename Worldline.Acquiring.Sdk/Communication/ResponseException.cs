...
namespace Worldline.Acquiring.Sdk.Communication
{
    ...
    public class ResponseException : Exception
    {
        ...
        /// <summary>
        /// Returns a <see cref="T:System.String"/> that represents the current <see cref="T:Worldline.Acquiring.Sdk.Communication.ResponseException"/>.
        /// </summary>
        /// <returns>A <see cref="T:System.String"/> that represents the current <see cref="T:Worldline.Acquiring.Sdk.Communication.ResponseException"/>.</returns>
