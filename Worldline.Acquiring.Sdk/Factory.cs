...
namespace Worldline.Acquiring.Sdk
{
    ...
    public static class Factory
    {
        ...
        {
            var configurationSection = System.Configuration.ConfigurationManager.GetSection("AcquiringSDK") as CommunicatorConfigurationSection;
        ...
        private static IAuthenticator GetAuthenticator(CommunicatorConfiguration configuration)
        {
            ...
            if (authorizationType == AuthorizationType.OAuth2)
            {
